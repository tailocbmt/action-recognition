...
def train_model(num_classes, csvPath, mode='train', num_epochs=45, save=True, path="model_data.pth.tar"):
    ...
    if mode == 'train':
        ...
        train_dataloader = DataLoader(TripletFrameDataset(csvPath), batch_size=10, shuffle=True, num_workers=4)
        ...
        val_dataloader = DataLoader(TripletFrameDataset(csvPath, mode='val'), batch_size=10, num_workers=4)
        ...
        print('Testing mode....')
        test_dataloader = DataLoader(TripletFrameDataset(csvPath, mode='test'), batch_size=10, shuffle=True, num_workers=4)
